...
const AuthLayout = ({
  ...
  return (
    <ScrollView
      ...
      <Card className="relative flex h-full w-full max-w-sm content-center justify-start gap-8 overflow-hidden border-0 bg-background p-7 shadow-none sm:border-border dark:bg-foreground">
        <CardHeader className="relative flex w-full flex-col gap-0 p-0">
          <View className="relative -mt-[8em] mb-2 flex h-fit max-h-[25em] w-full content-center items-center justify-center overflow-hidden">
            <View
              className={cn(
